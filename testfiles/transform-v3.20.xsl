...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="nibrsProperties">
        ...
        <xsl:for-each select="$counterfeited_S">
            &lt;nibrsProperties&gt;
            <!-- Element 2, Incident Number -->
            &lt;incidentNumber&gt;<xsl:value-of select="nc:Incident/nc:ActivityIdentification/nc:IdentificationID"/>&lt;/incidentNumber&gt;
            <xsl:apply-templates select="."/>
        ...
        <xsl:for-each select="$destroyed_S">
            &lt;nibrsProperties&gt;
            <!-- Element 2, Incident Number -->
            &lt;incidentNumber&gt;<xsl:value-of select="nc:Incident/nc:ActivityIdentification/nc:IdentificationID"/>&lt;/incidentNumber&gt;
            <xsl:apply-templates select="."/>
        ...
        <xsl:for-each select="$recovered_S">
            &lt;nibrsProperties&gt;
            <!-- Element 2, Incident Number -->
            &lt;incidentNumber&gt;<xsl:value-of select="nc:Incident/nc:ActivityIdentification/nc:IdentificationID"/>&lt;/incidentNumber&gt;
            <xsl:apply-templates select="."/>
    ...
    <xsl:template match="j:Victim">
        ...
        <xsl:for-each select="../j:SubjectVictimAssociation[j:Victim/@s:ref=current()/@s:id]">
            ...
            &lt;victimToOffenderRelationship&gt;<xsl:choose>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Acquaintance'">AQ</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Babysittee'">BE</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Boyfriend_Girlfriend'">BG</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Child of Boyfriend_Girlfriend'">CF</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Family Member_Child'">CH</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Family Member_Spouse_Common Law'">CS</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Employee'">EE</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Employer'">ER</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Friend'">FR</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Family Member_Grandchild'">GC</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Family Member_Grandparent'">GP</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Family Member_In-Law'">IL</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Neighbor'">NE</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Family Member'">OF</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='NonFamily_Otherwise Known'">OK</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Family Member_Parent'">PA</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Relationship Unknown'">RU</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Family Member_Sibling'">SB</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Family Member_Stepchild'">SC</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Family Member_Spouse'">SE</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Family Member_Stepparent'">SP</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Family Member_Stepsibling'">SS</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Stranger'">ST</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Victim Was Offender'">VO</xsl:when>
                <xsl:when test="*[local-name()='VictimToSubjectRelationshipCode']='Ex_Spouse'">XS</xsl:when>
                <xsl:otherwise><xsl:value-of select="*[local-name()='VictimToSubjectRelationshipCode']"/></xsl:otherwise>
